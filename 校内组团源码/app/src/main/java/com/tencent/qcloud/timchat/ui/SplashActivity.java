...
import com.tencent.qcloud.timchat.dfx.LoginActivity;
...
import com.tencent.qcloud.timchat.dfx.School;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (LOGIN_RESULT_CODE == requestCode) {
            ...
            if (0 == TLSService.getInstance().getLastErrno()){
                ...
                Intent intent = new Intent(SplashActivity.this, School.class);
                startActivity(intent);
                //navToHome();
