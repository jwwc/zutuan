...
public class ChatAdapter extends ArrayAdapter<Message> {
    ...
    public ChatAdapter(Context context, int resource, List<Message> objects) {
        ...
        //com.tencent.qcloud.ui.CircleImageView photo = (com.tencent.qcloud.ui.CircleImageView)LayoutInflater.from(context).inflate(resource,null);
        //photo.setImageResource(R.drawable.head_group);
        resourceId = resource;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView != null){
            ...
            viewHolder.head_photo = (CircleImageView)view.findViewById(R.id.rightAvatar);
